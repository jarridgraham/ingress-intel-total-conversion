...
var setup =  function() {
  ...
  //  window.plugin.farmFind.levelLayerGroup = new L.LayerGroup();
	$('body').append('<select onchange="window.plugin.farmFind.changeLevel()" id="farm_level_select"><option value=1>Disabled</option><option value=2>All Unclaimed+</option><option value=3>All L1+</option><option value=4>All L2+</option><option value=5>All L3+</option><option value=6>All L4+</option><option value=7>All L5+</option><option value=8>All L6+</option></select>');
    var myselect = document.getElementById("farm_level_select");
